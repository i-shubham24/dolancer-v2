    ...
    <section ref={scopeRef} className="overflow-clip border-t-2 border-ink bg-bone pb-16 md:pb-24">
      <div className="fresh-container">
        <motion.div
          ...
          className="grid grid-cols-1 gap-8 border-2 border-ink bg-primary p-8 sm:p-10 md:p-12 lg:grid-cols-12 lg:items-end"
        >
          <div className="lg:col-span-8" data-cta-drift>
