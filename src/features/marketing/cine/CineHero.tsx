...
export function CineHero() {
  ...
  useLayoutEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      const tl = gsap.timeline({
        scrollTrigger: { trigger: ref.current, start: "top top", end: "+=70%", pin: true, scrub: 0.6, anticipatePin: 1 },
      });
  ...
  return (
    <section ref={ref} className="relative overflow-clip bg-[#0A1912] pb-14 pt-6 md:pb-20 md:pt-8">
      ...
      <div className="mx-auto max-w-[1400px] px-4 md:px-8">
        ...
        <div className="relative">
          ...
          <h1 className="mt-12 md:mt-16 font-display text-[clamp(2.75rem,10vw,8.5rem)] font-extrabold leading-[0.94] tracking-[-0.02em] text-[#F3EFE3]">
